...
public class AnalyzePlaylistUseCaseFactory {
    ...
    public static AnalyzedPlaylistView create (ViewManagerModel viewManagerModel,
        ...
        return new AnalyzedPlaylistView(analyzePlaylistViewModel, analyzePlaylistController);
    }
