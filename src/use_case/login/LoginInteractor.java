...
//    static final String REDIRECT_URI = "http://localhost:8888/callback";
    ...
    public LoginInteractor(LoginDataAccessInterface userDataAcessObject, LoginOutputBoundary loginPresenter, LoginAPIHandler handler){
...
//        connection.disconnect();
        ...
        try {
            ...
            LoginOutputData loginOutputData = new LoginOutputData("", true);
